...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_view_sa = QtWidgets.QWidget()
        self.scroll_view_sa.setGeometry(QtCore.QRect(0, 0, 738, 690))
        self.scroll_view_sa.setObjectName("scroll_view_sa")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.scroll_view_sa)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.scroll_w = QtWidgets.QWidget(self.scroll_view_sa)
        self.scroll_w.setObjectName("scroll_w")
        self.source_lb = QtWidgets.QLabel(self.scroll_w)
        self.source_lb.setGeometry(QtCore.QRect(336, 329, 47, 16))
        ...
        self.image_sa.setWidget(self.scroll_view_sa)
