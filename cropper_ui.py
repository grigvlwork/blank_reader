...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/save.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/newfile.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.new_project_btn.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/checkmark.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("images/checklist.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.check_all_btn.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/images/vert.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.vert_btn.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/images/horiz.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.horiz_btn.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/images/crop.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.crop_btn.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("images/Angle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.angle_btn.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("images/clockwise_rotate.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rotate_clock_btn.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("images/counterclockwise_rotate.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rotate_counter_clock_btn.setIcon(icon11)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/images/images/zoom_out.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoom_out_btn.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/images/images/zoom_in.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoom_in_btn.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("images/run.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.execute_btn.setIcon(icon15)
