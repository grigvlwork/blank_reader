...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/vert.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.vert_btn.setIcon(icon1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/images/crop.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/images/hand.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.hand_btn.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/images/angle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.angle_btn.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/images/zoom_out.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/images/zoom_in.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/images/horiz.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.horiz_btn.setIcon(icon8)
        ...
        self.source_gv = QtWidgets.QGraphicsView(self.tab)
        self.source_gv.setObjectName("source_gv")
        self.horizontalLayout_3.addWidget(self.source_gv)
        ...
        self.result_gv = QtWidgets.QGraphicsView(self.tab_3)
        self.result_gv.setObjectName("result_gv")
        self.horizontalLayout_4.addWidget(self.result_gv)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Исходник"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_3), _translate("MainWindow", "Результат"))
import icons_rc
