...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.add_word_btn.sizePolicy().hasHeightForWidth())
        self.add_word_btn.setSizePolicy(sizePolicy)
        self.add_word_btn.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("images/add_word.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_word_btn.setIcon(icon6)
        self.add_word_btn.setIconSize(QtCore.QSize(32, 32))
        self.add_word_btn.setObjectName("add_word_btn")
        self.horizontalLayout.addWidget(self.add_word_btn)
        self.increase_word_btn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.increase_word_btn.sizePolicy().hasHeightForWidth())
        self.increase_word_btn.setSizePolicy(sizePolicy)
        self.increase_word_btn.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("images/increase_word.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.increase_word_btn.setIcon(icon7)
        self.increase_word_btn.setIconSize(QtCore.QSize(32, 32))
        self.increase_word_btn.setObjectName("increase_word_btn")
        self.horizontalLayout.addWidget(self.increase_word_btn)
        self.confirm_word_btn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.confirm_word_btn.sizePolicy().hasHeightForWidth())
        self.confirm_word_btn.setSizePolicy(sizePolicy)
        self.confirm_word_btn.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("images/confirm_word.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.confirm_word_btn.setIcon(icon8)
        self.confirm_word_btn.setIconSize(QtCore.QSize(32, 32))
        self.confirm_word_btn.setObjectName("confirm_word_btn")
        self.horizontalLayout.addWidget(self.confirm_word_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_word_btn.setToolTip(_translate("MainWindow", "Добавить слово"))
        self.increase_word_btn.setToolTip(_translate("MainWindow", "Увеличить слово"))
        self.confirm_word_btn.setToolTip(_translate("MainWindow", "Сохранить слово"))
